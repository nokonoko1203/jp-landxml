...
use crate::models::{LandXML, CoordinateSystem};
...
impl JLandXmlCoordinateSystem {
    ...
    pub fn with_vertical_datum(mut self, vertical_datum: super::coordinate_systems::VerticalDatum) -> Self {
    ...
    /// 座標系の妥当性をバリデーション
    pub fn validate(&self) -> Result<Vec<super::coordinate_systems::ValidationWarning>, crate::error::LandXMLError> {
        if let Some(zone) = self.plane_coordinate_zone {
            ...
            Err(crate::error::LandXMLError::InvalidCoordinateSystemNameFormat { 
...
impl JLandXmlDocument {
    ...
    pub fn from_base(base: LandXML) -> Self {
        ...
        let coordinate_system = base.coordinate_system.as_ref()
...
mod tests {
    ...
    fn test_jlandxml_coordinate_system_creation() {
        ...
        assert_eq!(jlandxml_cs.horizontal_coordinate_system_name, "9(X,Y)".to_string());
        assert_eq!(jlandxml_cs.plane_coordinate_zone, Some(JapanPlaneCoordinateSystem::Zone9));
